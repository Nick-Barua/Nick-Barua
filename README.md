...
[![ISNI](https://img.shields.io/badge/ISNI-0000_0005_3020_7165-4A90D9?style=flat-square)](https://isni.org/isni/0000000530207165)
...
> **Physicist · Executive · Researcher** | Hyogo, Japan 🇯🇵
...
My research addresses a critical and largely unresolved gap in road traffic safety: the detection and injury-risk modelling of pedestrians in non-upright postures — individuals already lying on the road surface due to medical emergency, intoxication, or displacement following a prior collision. These victims carry a forensic fatality rate of 33.0%, more than double the rate for upright pedestrian collisions, yet remain outside the effective detection envelope of every current ADAS standard.
...
| *Baseline (Monocular RGB, Night)* | *21.4* | *N/A* | *N/A* |
