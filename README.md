...
[![GitHub](https://img.shields.io/badge/GitHub-Nick--Barua-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Nick-Barua)

> **Physicist and Researcher** working at the intersection of automotive safety, forensic medicine, and geospatial intelligence. Based in Hyogo, Japan.
> BSc Physics — Yale · MSc Astrophysics — Caltech · PhD — University of Hertfordshire

My research focuses on translating high-dimensional signal analysis and galactic kinematic models into safety-critical terrestrial applications. By bridging **Forensic Biomechanics** with **Functional Safety (ISO 26262)**, my work aims to eliminate the "classification gap" for vulnerable road users during sudden incapacitation events.

---

## 🏛 Academic Affiliations & Leadership

### 🎓 Academic Appointments
- **Visiting Professor**, Shiga University of Medical Science (SUMS) — Dept. of Legal Medicine, since 2022
- **Visiting Professor**, Kobe Gakuin University — Dept. of Social Studies of Disaster Management, since 2022
- **Visiting Professor**, University of Science and Technology, Chittagong — Since 2022

### 🏢 Executive Roles
- **Chairman & CEO**, [AN Holdings Co.](https://anholdings.co/) — Strategic tech-investment across North Asia
- **Director**, [New Space Intelligence (NSI)](https://newspaceint.com/) — Satellite data analytics and geospatial AI
- **Executive Chairman**, [Hucha Co., Ltd](https://www.hucha.co.jp/) — Management and sales consulting

---

## 🔬 Core Research: AFODS & ISO 26262 Compliance

My current work addresses the detection of "invisible" pedestrians—individuals in non-upright postures due to medical emergencies or primary collisions. This is managed via the **Advanced Falling Object Detection System (AFODS)**.

### 🛠 Technical Contributions & IP
...
The KSF transposes mathematical rigor from **Galactic Archaeology** into a proactive engine for terrestrial safety.
...
- **Advanced Multi-Modal Sensor Fusion System for Detecting Falling Humans** | *MDPI Vehicles* | [doi: 10.3390/vehicles7040149](https://doi.org/10.3390/vehicles7040149)
